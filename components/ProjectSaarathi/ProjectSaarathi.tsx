  ...
  return (
    ...
    >
      <div className="text-white col-start-2 md:col-start-3 col-span-5 flex flex-col gap-7">
        ...
        <p className="text-fWhite">
          Project Saarathi is the inaugural initiative launched by We-Saarathi,
          firmly grounded in the overarching theme of &quot;Tech for Aid.&quot;
          Driven by unwavering dedication, this innovative project endeavors to
          extend crucial support to visually impaired students, empowering them
          to overcome challenges and realize their educational dreams.
        </p>
        <Link
          href="https://project.wesaarathi.org/"
      ...
      <div className="custom-shape-divider-bottom-1690809554">
        <svg
          data-name="Layer 1"
...
export default ProjectSaarathi;
